...
<div id="login-logo-div">
    ...
    <label class="login-title-label main-label-style" > Please Login First.</label>
        ...
        <form  style="max-width:500px;margin:auto" action="{{url('users/employee/login')}}" method="post">
        {{ csrf_field() }}
        ...
        <button type="submit"   name="user-login-btn" class="log-in-btn">Employee Log In</button>
        <br>
