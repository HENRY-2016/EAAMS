...
<div id="login-logo-div">
    ...
    <label class="login-title-label main-label-style" > Please Login First.</label>
        ...
        <form  style="max-width:500px;margin:auto" action="{{url('users/humanResource/login')}}" method="post">
        {{ csrf_field() }}
        ...
        <button type="submit"   name="user-login-btn" class="log-in-btn">HR Log In</button>
        <br>
